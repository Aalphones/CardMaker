...
final class TemplatePreviewController
{
    ...
    public function upload(string $id): void
    {
        ...
        if (!$this->previews->templateExists($templateId)) {
            $this->notFound();
        ...
        try {
            $result = $this->previews->store($templateId, $file);
    ...
    {
        Response::error(Response::ERROR_NOT_FOUND, 'Für dieses Template gibt es kein Vorschaubild.', 404);
    }
}
