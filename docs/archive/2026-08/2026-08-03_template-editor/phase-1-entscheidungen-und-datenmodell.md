...
- [x] **ADR-014 schreiben** — `docs/decisions/014-template-layout-als-datenblock.md`.
...
- [x] **ADR-015 schreiben** — `docs/decisions/015-bildablage-und-dateiformate.md`.
      ...
      **außerhalb** des ausgelieferten Bereichs (ADR-013), und werden von PHP über
      ...
      wurden.
- [x] **Doc-Update `docs/glossary.md`** — neue Zeilen: **Bildvorrat** (die hochgeladenen
...
- [x] **Doc-Update `docs/glossary.md`, bestehende Zeile „ImageLayer" schärfen** — das
...
- [x] **Doc-Update `docs/PROJECT.md`** — unter „Offene Fragen" den Punkt zum Datenbankschema
      ...
      (ADR-014).
- [x] **Doc-Update `docs/decisions/README.md`** — die beiden neuen Einträge in die Liste
      aufnehmen, falls dort eine geführt wird.

## Report-Back

ADR-014 und ADR-015 geschrieben, in `docs/decisions/README.md` gelistet. Glossar um
Bildvorrat, Feldschlüssel, Ebenenreihenfolge ergänzt, ImageLayer-Zeile präzisiert
(Zoom/Bildausschnitt gehören zur Karteninstanz, nicht zum Template). PROJECT.md: offene
Frage zum DB-Schema gestrichen, Halbsatz zu ADR-014 bei Meilenstein 2 ergänzt. Reine
Doku-Phase, keine Deviations.
