...
- [ ] `mcp/pyproject.toml` anlegen (Werte s.o.).
- [ ] `mcp/cardmaker_mcp/__init__.py`, `__main__.py` (startet `server.main()`).
- [ ] `mcp/cardmaker_mcp/client.py`: Token-Auflösung (Konstruktor → `CM_TOKEN` → `.cm_token`),
