...
| # | Phase | Rating | Status |
|---|---|---|---|
| 1 | [Entscheidungen & Datenmodell festhalten](phase-1-entscheidungen-und-datenmodell.md) | mechanisch | pending |
| 2 | [Bildvorrat im Backend](phase-2-bildvorrat-backend.md) | heikel | pending |
